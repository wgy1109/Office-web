...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="#">${fns:getConfig('productName')}</a> - Powered By <a href="http://www.chanzor.com" target="_blank">Chanzor team</a> ${fns:getConfig('version')}
	</div>
