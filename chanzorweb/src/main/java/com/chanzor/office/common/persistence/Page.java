 ...
 */
package com.chanzor.office.common.persistence;
...
import com.chanzor.office.common.utils.CookieUtils;
...
public class Page<T> {
	...
	public void initialize() {
		...
		this.last = (int) (count / (this.pageSize < 1 ? 20 : (this.pageSize > 500 ? 500 : this.pageSize)) + first - 1);
	 ...
	 * @param list
	 */
	public Page<T> setListMap(List<Map<String, Object>> list2) {
		// this.list = list2;
		initialize();
		return this;
	}
