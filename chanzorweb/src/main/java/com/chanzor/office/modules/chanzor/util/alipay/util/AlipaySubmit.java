...
import com.chanzor.office.modules.chanzor.util.alipay.sign.MD5;
import com.chanzor.office.modules.chanzor.util.alipay.util.httpClient.HttpProtocolHandler;
import com.chanzor.office.modules.chanzor.util.alipay.util.httpClient.HttpRequest;
import com.chanzor.office.modules.chanzor.util.alipay.util.httpClient.HttpResponse;
import com.chanzor.office.modules.chanzor.util.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static boolean verify(Map<String, String> param){
		...
		Map<String, String> s = AlipayCore.paraFilter(param);
		String text = AlipayCore.createLinkString(s);
		return MD5.verify(text, sign, AlipayConfig.key, AlipayConfig.input_charset);
	} 
    /**
