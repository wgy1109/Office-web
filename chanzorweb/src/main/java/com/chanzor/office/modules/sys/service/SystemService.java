...
import com.chanzor.office.common.security.Digests;
import com.chanzor.office.common.security.shiro.session.SessionDAO;
import com.chanzor.office.common.service.BaseService;
import com.chanzor.office.common.service.ServiceException;
import com.chanzor.office.common.utils.CacheUtils;
import com.chanzor.office.common.utils.Encodes;
import com.chanzor.office.common.utils.StringUtils;
import com.chanzor.office.common.web.Servlets;
import com.chanzor.office.modules.sys.dao.MenuDao;
import com.chanzor.office.modules.sys.dao.RoleDao;
import com.chanzor.office.modules.sys.dao.UserDao;
import com.chanzor.office.modules.sys.entity.Menu;
import com.chanzor.office.modules.sys.entity.Office;
import com.chanzor.office.modules.sys.entity.Role;
import com.chanzor.office.modules.sys.entity.User;
import com.chanzor.office.modules.sys.security.SystemAuthorizingRealm;
import com.chanzor.office.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void saveUser(User user) {
		if (StringUtils.isBlank(user.getId())){
			...
			user.preInsert();
			String id = oaCodeGeneratorService.getUserTableSequenceId();
			user.setId(id);
			userDao.insert(user);*/
		}else{
			// 清除原用户机构用户缓存
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.chanzor.com/\r\n");
		sb.append("\r\n======================================================================\r\n");
	...
	public User findAllTypeUserByLoginName(String name){
		return userDao.findAllTypeUserByLoginName(name);
	}
