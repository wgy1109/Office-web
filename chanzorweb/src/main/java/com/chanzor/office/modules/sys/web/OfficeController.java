...
import com.chanzor.office.modules.sys.service.OfficeService;
...
public class OfficeController extends BaseController {
	...
	public List<Map<String, Object>> treeData(@RequestParam(required = false) String extId,
		...
		if (user.getOffice().getId().equals(saleOfficeId)) {
			list = officeService.findSaleOffice(user.getOffice());
		} else {
